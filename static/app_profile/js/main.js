(function() {
  ...
  if (selectHeader) {
    const headerScrolled = () => {
      ...
      if (window.scrollY > 100 || url.includes('projects-details') || !valid) {
        selectHeader.classList.add('header-scrolled')
        selectDropdown.classList.remove('invisible-dropdown')
        selectDropdown.classList.add('visible-dropdown')
      } else {
        selectHeader.classList.remove('header-scrolled')
        selectDropdown.classList.add('invisible-dropdown')
        selectDropdown.classList.remove('visible-dropdown')
      }
    }
  ...
  window.addEventListener('load', () => {
    ...
    if (projectsContainer && !url.includes('projects-details')) {
